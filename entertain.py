...
bfg = media.Movie("The BFG",
                  "Ten-year-old Sophie is in for the adventure of a\
                   lifetime when she meets the Big Friendly Giant",
...
zootopia = media.Movie("Zootopia",
                       "Judy gets at the opportunity to\
...
jurassic = media.Movie("Jurassic World",
                       "When the massive creature escapes, it\
                       sets off a chain reaction that causes the other dinos to run amok",
